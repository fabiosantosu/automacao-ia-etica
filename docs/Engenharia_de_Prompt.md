...
```text
Atue como um Analista de Vendas Sênior. Sua tarefa é qualificar a [Mensagem do Lead].
Critérios: 
- Quente: Dor específica e urgência clara.
...
Justificativa: Baseie-se apenas em evidências de domínio de ferramentas (SQL, Python, Excel).
